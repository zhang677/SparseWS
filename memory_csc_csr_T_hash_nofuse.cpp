...
void memory_hash_outer_transpose_nofuse(const string filename1, const string filename2, bool verbose) {
    taco_tensor_t C;
    EigenCSR C_true;
    vector<int> indptr;
    vector<int> indices;
...
int main(int argc, char* argv[]) {
    ...
    memory_hash_outer_transpose_nofuse(filename1, filename2, verbose);
    return 0;
}
#include "benchmark/DCSC_DCSR/DCSC_DCSR_coiter.h"
#include <iostream>
#include <time.h>
#include <string>
#include <fstream>
...
void bench_iter_outer_CC_noT(const string filename1, const string filename2, const int repeat, const string& result_name, pid_t pid) {
    taco_tensor_t C;
    vector<int> indptr;
    vector<int> indices;
    ...
    duration_taco = DCSC_DCSR_iteration(&A, &B, &C, warmup, repeat, true);
...
int main(int argc, char* argv[]) {
    ...
    bench_iter_outer_CC_noT(filename1, filename2, repeat, result_name, pid);

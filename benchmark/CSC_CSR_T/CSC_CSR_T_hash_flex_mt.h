...
void Merge_hash(int32_t* COO1_crd_0, int32_t* COO2_crd_0, float* COO_vals_0, int32_t* COO1_crd_1, int32_t* COO2_crd_1, float* COO_vals_1, int32_t* COO_size, HashTable* w) {
...
void init_hashTable(HashTable* w, int32_t w_accumulator_capacity) {
  ...
  w->buffer_capacity = w_accumulator_capacity * 4 < 0? CAPMAX : w_accumulator_capacity * 4;
...
int compute(taco_tensor_t *C, taco_tensor_t *A, taco_tensor_t *B, int32_t w_accumulator_capacity) {
    ...
    for (int32_t iA = A2_pos[j]; iA < A2_pos[(j + 1)]; iA++) {
      ...
      for (int32_t kB = B2_pos[j]; kB < B2_pos[(j + 1)]; kB++) {
        ...
        if (acc_array_id == 0) {
          ...
          TryInsert_hash(w_insertFail, &w_accumulator_0, w_point, (A_vals[iA] * B_vals[kB]), C2_dimension);
        } else {
          TryInsert_hash(w_insertFail, &w_accumulator_1, w_point, (A_vals[iA] * B_vals[kB]), C2_dimension);
        }
        ...
        if (w_insertFail[0]) {
          ...
          if (acc_array_id == 0) {
            ...
            if ((all_array_id == 0 && w_accumulator_0.numel + w_all_size[0] > w_all_capacity_1) ||
                (all_array_id == 1 && w_accumulator_0.numel + w_all_size[0] > w_all_capacity_0)) {
                
                if (all_array_id == 1) {
                  w_all_capacity_0 = w_accumulator_0.numel + w_all_size[0];
                  ...
                  w_all_capacity_1 = w_accumulator_0.numel + w_all_size[0];
            ...
            if (all_array_id == 0) {
                t = std::thread(Merge_hash, w1_crd_0, w2_crd_0, w_vals_0, w1_crd_1, w2_crd_1, w_vals_1, w_all_size, &w_accumulator_0);
            }
            else {
                t = std::thread(Merge_hash, w1_crd_1, w2_crd_1, w_vals_1, w1_crd_0, w2_crd_0, w_vals_0, w_all_size, &w_accumulator_0);
            }
            all_array_id ^= 1;
            acc_array_id = 1;
            ...
            if ((all_array_id == 0 && w_accumulator_1.numel + w_all_size[0] > w_all_capacity_1) ||
                (all_array_id == 1 && w_accumulator_1.numel + w_all_size[0] > w_all_capacity_0)) {
                
                if (all_array_id == 1) {
                  w_all_capacity_0 = w_accumulator_1.numel + w_all_size[0];
                  w1_crd_0 = (int32_t*)realloc(w1_crd_0, sizeof(int32_t) * w_all_capacity_0);
                  w2_crd_0 = (int32_t*)realloc(w2_crd_0, sizeof(int32_t) * w_all_capacity_0);
                  w_vals_0 = (float*)realloc(w_vals_0, sizeof(float) * w_all_capacity_0);
                } else {
                  w_all_capacity_1 = w_accumulator_1.numel + w_all_size[0];
                  w1_crd_1 = (int32_t*)realloc(w1_crd_1, sizeof(int32_t) * w_all_capacity_1);
                  w2_crd_1 = (int32_t*)realloc(w2_crd_1, sizeof(int32_t) * w_all_capacity_1);
                  w_vals_1 = (float*)realloc(w_vals_1, sizeof(float) * w_all_capacity_1);
                }
            ...
            if (all_array_id == 0) {
                t = std::thread(Merge_hash, w1_crd_0, w2_crd_0, w_vals_0, w1_crd_1, w2_crd_1, w_vals_1, w_all_size, &w_accumulator_1);
            }
            else {
                t = std::thread(Merge_hash, w1_crd_1, w2_crd_1, w_vals_1, w1_crd_0, w2_crd_0, w_vals_0, w_all_size, &w_accumulator_1);
            }       
            all_array_id ^= 1;    
            acc_array_id = 0;
  ...
  if (acc_array_id == 0) {
    if (w_accumulator_0.numel > 0) {
      ...
      if (all_array_id == 0) {
          Merge_hash(w1_crd_0, w2_crd_0, w_vals_0, w1_crd_1, w2_crd_1, w_vals_1, w_all_size, &w_accumulator_0);
      }
      else {
          Merge_hash(w1_crd_1, w2_crd_1, w_vals_1, w1_crd_0, w2_crd_0, w_vals_0, w_all_size, &w_accumulator_0);
      }
      all_array_id ^= 1;
    }
  } 
    ...
    if (w_accumulator_1.numel > 0) {
      ...
      if (all_array_id == 0) {
          Merge_hash(w1_crd_0, w2_crd_0, w_vals_0, w1_crd_1, w2_crd_1, w_vals_1, w_all_size, &w_accumulator_1);
      }
      else {
          Merge_hash(w1_crd_1, w2_crd_1, w_vals_1, w1_crd_0, w2_crd_0, w_vals_0, w_all_size, &w_accumulator_1);
      }
      all_array_id ^= 1;
    }
  }
...
double CSC_CSR_T_hash(taco_tensor_t *A, taco_tensor_t *B, taco_tensor_t* C, int32_t w_cap, int32_t warmup, int32_t repeat, bool bench = false, bool print = false) {

...
void check_ttmil_coord_hash(const string filename1, const string filename2, vector<int>& dims) {
    taco_tensor_t B;
    ...
    COO_CSF_DCSR_hash(&A, &B, &C, w_cap, 1, 0, false/*in bench*/);
...
int main(int argc, char* argv[]) {
    ...
    check_ttmil_coord_hash(filename1, filename2, dims);

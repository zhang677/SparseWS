name=$1
exec=/home/zgh23/code/SparseWS/bench-cc-noT-ITER
matrix_root=/scratch/zgh23/sparse_mat
trans_root=/scratch/zgh23/sparse_mat_t
output=/home/zgh23/code/SparseWS/data/profile/CSC_CSR/cc/bench-cc-noT-ITER.csv
# $exec -matrixA $matrix_root/$name.mtx -matrixB $trans_root/$name-st.mtx -iter 20 -result $output
$exec $matrix_root/$name.mtx $trans_root/$name-st.mtx 20 $output

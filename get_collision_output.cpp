#include "evaluate/CSC_CSR_T_hash_record.h"

void record_hash_outer_transpose(const string filename1, const string filename2, const string result_name) {
    taco_tensor_t C;
    EigenCSR C_true;
    vector<int> indptr;
    vector<int> indices;
    ...
    //w_cap = 3;
    CSC_CSR_T_hash(&A, &B, &C, w_cap, collisions);
...
int main(int argc, char* argv[]) {
    ...
    record_hash_outer_transpose(filename1, filename2, filename3);
    return 0;
}